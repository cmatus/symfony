...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gestionatalento', 'user' => 'root', 'password' => 'W3nj1t0_', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Gt\\SistemaBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Gt\\UserBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'Gt\\SistemaBundle\\Entity');
        $d->addDriver($c, 'Gt\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'GtSistemaBundle' => 'Gt\\SistemaBundle\\Entity', 'UserBundle' => 'Gt\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f18c4ffbcc643fc56215d15d5e8f4c5f67d943baa872b76a3ec723a6ab046f75');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Gt\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Gt\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Gt\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $m->setOptions(array('login_path' => '/login', 'default_target_path' => '/inicio', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Gt\\SistemaBundle/Resources/views'), 'GtSistema');
        $instance->addPath(($this->targetDirs[3].'\\src\\Gt\\UserBundle/Resources/views'), 'User');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GtSistemaBundle' => 'Gt\\SistemaBundle\\GtSistemaBundle',
                'UserBundle' => 'Gt\\UserBundle\\UserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'gestionatalento',
            'database_user' => 'root',
            'database_password' => 'W3nj1t0_',
            ...
            'fos_user.model.user.class' => 'Gt\\UserBundle\\Entity\\User',
