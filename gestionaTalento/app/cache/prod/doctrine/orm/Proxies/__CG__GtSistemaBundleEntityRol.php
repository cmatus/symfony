 ...
 */
class Rol extends \Gt\SistemaBundle\Entity\Rol implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\Rol' . "\0" . 'rol', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\Rol' . "\0" . 'usuario');
        }
