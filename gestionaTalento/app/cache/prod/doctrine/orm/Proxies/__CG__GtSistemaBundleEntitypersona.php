 ...
 */
class persona extends \Gt\SistemaBundle\Entity\persona implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'id', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'empresaId', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'perfilId', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'personaId', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'personaRut', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'personaNombre', '' . "\0" . 'Gt\\SistemaBundle\\Entity\\persona' . "\0" . 'personaCorreo');
        }
    ...
    public function setPersonaRut($personaRut)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPersonaRut', array($personaRut));

        return parent::setPersonaRut($personaRut);
    }
    ...
    public function getPersonaRut()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPersonaRut', array());

        return parent::getPersonaRut();
    }
    ...
    public function setPersonaNombre($personaNombre)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPersonaNombre', array($personaNombre));

        return parent::setPersonaNombre($personaNombre);
    }
    ...
    public function getPersonaNombre()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPersonaNombre', array());

        return parent::getPersonaNombre();
    }
    ...
    public function setPersonaCorreo($personaCorreo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPersonaCorreo', array($personaCorreo));

        return parent::setPersonaCorreo($personaCorreo);
    }
    ...
    public function getPersonaCorreo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPersonaCorreo', array());

        return parent::getPersonaCorreo();
    }
